...
function deObjetoAmatriz(objeto){
  ...
  // un "for in" itera propiedades de un objeto! (creo una variable comun + in + el objeto a trabajar)
    matriz.push([prop, objeto[prop]]) // el [prop] es como el "i" comun en el for in.
  }
  return matriz;
}
...
function deleteAbc(cadena){
  ...
  for(var i = 0; i < cadena.length; i++){
    if(cadena[i] !== "a" && cadena[i] !== "b" && cadena[i] !== "c"){
      strDelete = strDelete + cadena[i];
    }
  }
  return strDelete;
}

// CON MÉTODOS. OPCIÓN 2
/* 
